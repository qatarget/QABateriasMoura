...
public class BasePage {
	...
	public String geraNomeAleatorio() {
		String[] nomes = { "Antonio", "Rafael", "Bruno", "Marcelo", "Alberto", "Pedro", "Anderson", "Airton", "Sidney",
				"Wilson", "Carlos", "C�ndido", "Hugo", "Jo�o", "Mauro", "Leonardo", "Natanael", "Reinaldo",
				"Orlando", "Tiago", "Gildo", "Alfredo", "Maur�cio", "Jurandir", "Paulo", "Juv�ncio", "Daniel",
				"Jair", "Juvenal", "Jorge" };
